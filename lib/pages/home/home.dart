                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Center(
                                child: Icon(Ionicons.md_document_text_outline),
                              ),
                            ),
                          ),
                          const SizedBox(
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: const Text(
                                  'https://bullafric.xwapy.com/username',
                                  style: TextStyle(
                                    color: Color(0xffC5C5C5),
                                  ),
                                ),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      value: controller.nairaValueConvert.value,
                                      onChanged: (v) {
                                        controller.nairaValueConvert.value = v;
                                      },
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: DropdownButton(
                                      ...
                                      underline: const SizedBox(),
                                      onChanged: (v) {
                                        controller.cryptoValueConvert.value = v;
                                      },
                                      value:
                          ...
                          onTap: () {
                            if (formKey.currentState!.validate()) {
                              return Get.toNamed('/enteraddresscrypto',
                                  arguments: {
                                    "from": controller.nairaValueConvert.value,
                                    "to": controller.cryptoValueConvert.value,
                                ...
                                swappController
                                    .createCryptoToFiatOrder(
                                        from: controller
                                            ...
                                            .split('-')
                                            .first,
                                        to: controller.nairaValueConvert.value
                                            .toString(),
                                        network: controller
                                            .cryptoValueConvert.value
                                            .toString()
